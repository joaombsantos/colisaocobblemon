...
public class PokeMinerMenu extends AbstractContainerMenu {

    private final Container container;
    private final ContainerData data;
    private final BlockPos blockPos;
    private final PokeMinerBlockEntity blockEntity;

    public PokeMinerMenu(int syncId, Inventory playerInventory, BlockPos pos) {
    ...
    public PokeMinerMenu(int syncId, Inventory playerInventory, Container container, ContainerData data, BlockPos pos) {
        super(ModScreenHandlers.POKE_MINER_MENU, syncId);
        this.container = container;
        this.data = data;
        this.blockPos = pos;

        if (playerInventory.player.level().getBlockEntity(pos) instanceof PokeMinerBlockEntity be) {
            this.blockEntity = be;
        } else {
